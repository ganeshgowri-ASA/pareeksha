    ...
    <div className="overflow-x-auto">
      <div className="min-w-[800px]">
        ...
        {results.map((result) => {
          ...
          const colorClass = CHAMBER_COLORS[chamber.category] || 'bg-gray-500';
        ...
        <div className="bg-white p-3 rounded-b-lg border-t border-slate-200">
          <div className="flex flex-wrap gap-3">
            {results.map((r) => {
              ...
              const colorClass = chamber ? (CHAMBER_COLORS[chamber.category] || 'bg-gray-500') : 'bg-gray-500';
              return (
